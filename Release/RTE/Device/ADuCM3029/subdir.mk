...
RTE/Device/ADuCM3029/%.o: ../RTE/Device/ADuCM3029/%.S
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -DCORE0 -DNDEBUG -D_RTE_ -D__ADUCM3029__ -D__SILICON_REVISION__=0x100 @includes-b7ac86c629434ccd36c9bed3ba4f456c.txt -mcpu=cortex-m3 -mthumb -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
